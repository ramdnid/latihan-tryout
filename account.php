...
<tr><td><b>S.N.</b></td><td><b>Mata Pelajaran</b></td><td><b>Jumlah Pertanyaan</b></td><td><b>Nilai</b></td><td><b>Waktu</b></td><td></td></tr>';
$c=1;
...
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="" class="pull-right btn sub1" style="margin:0px;background:red"><span class="" aria-hidden="true"></span>&nbsp;<span class="title1"><b>SELESAI</b></span></a></b></td></tr>';
}
}
$c=0;
echo '</table></div></div>';
...
<tr style="color:red"><td><b>S.N.</b></td><td><b>Mata Pelajaran</b></td><td><b>Jumlah Soal</b></td><td><b>Benar</b></td><td><b>Salah<b></td><td><b>Nilai</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Ranking</b></td><td><b>Nama</b></td><td><b>Jenis Kelamin</b></td><td><b>Kelas</b></td><td><b>Nilai</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
